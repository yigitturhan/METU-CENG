...
vec3 kd = vec3( 0.8, 0.8, 0.4);     // diffuse reflectance coefficient
vec3 ka = vec3(0.3, 0.2, 0.05);   // ambient reflectance coefficient
vec3 ks = vec3(0.75, 0.6, 0.3);   // specular reflectance coefficient
...
void main(void)
{
	...
	vec3 specularColor = I * ks * pow(max(0, NdotH), 50);
