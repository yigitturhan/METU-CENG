...
vec3 Iamb = vec3(0.8, 0.0, 0.0); // ambient light intensity
vec3 kd = vec3(0, 0, 0);     // diffuse reflectance coefficient
vec3 ka = vec3(0.8, 0.0, 0.0);   // ambient reflectance coefficient
vec3 ks = vec3(0.8, 0.0, 0.0);   // specular reflectance coefficient
