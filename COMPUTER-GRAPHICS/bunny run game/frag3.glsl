...
vec3 kd = vec3( 0.5, 0.5, 1.0);     // diffuse reflectance coefficient
vec3 ka = vec3(0.3, 0.3, 0.5);   // ambient reflectance coefficient
vec3 ks = vec3(0.8, 0.8, 1.0);   // specular reflectance coefficient
