...
vec3 kd = vec3(0.0, 0.5, 0.5);     // diffuse reflectance coefficient
vec3 ka = vec3(0.0, 0.5, 0.5);   // ambient reflectance coefficient
vec3 ks = vec3(0.0, 0.5, 0.5);   // specular reflectance coefficient
