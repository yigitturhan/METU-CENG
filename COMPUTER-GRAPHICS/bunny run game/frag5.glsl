...
vec3 kd = vec3( 0.5, 0.0, 0.0);     // diffuse reflectance coefficient
vec3 ka = vec3(0.5,0.0, 0.0);   // ambient reflectance coefficient
vec3 ks = vec3(0.9, 0.0, 0.0);   // specular reflectance coefficient
